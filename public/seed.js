...
(function (root, factory) {
  ...
  function buildSeed(uid) {
    const id = { emma: uid(), jack: uid(), tom: uid(), lily: uid(), ben: uid(), anna: uid() };

    const clients = [
      { id: id.emma, name: "Emma Clark", phone: "555-0142", email: "emma.clark@example.com",
      ...
      { id: id.jack, name: "Jack Miller", phone: "555-0119", email: "",
      ...
      { id: id.ben, name: "Ben Turner", phone: "555-0188", email: "",
        tags: ["swimming", "junior"], isMinor: true,
        guardian: { name: "Kate Turner", contact: "555-0177" },
      ...
      { id: id.lily, name: "Lily Hayes", phone: "555-0165", email: "",
        tags: ["athletics", "junior"], isMinor: true,
        guardian: { name: "Mark Hayes", contact: "mark.hayes@example.com" },
        consent: { obtained: false },
        fields: { Age: "15", Event: "400m" },
        notes: [], created: at(-8, 9) },

      { id: id.tom, name: "Tom Reed", phone: "", email: "t.reed@example.com",
      ...
      { id: id.anna, name: "Anna Foster", phone: "555-0101", email: "",
    ...
    const events = [
      { id: uid(), title: "Lesson",   clientId: id.emma,   start: at(0, 16),     durationMin: 60, location: "Court 3", notes: "" },
      { id: uid(), title: "Lesson",   clientId: id.jack,  start: at(0, 17, 30), durationMin: 60, location: "Court 1", notes: "" },
      { id: uid(), title: "Session",  clientId: id.tom, start: at(1, 10),     durationMin: 45, location: "Zoom",    notes: "Prep for the board update" },
      { id: uid(), title: "Lesson",   clientId: id.ben,    start: at(1, 7),      durationMin: 90, location: "Lane 4",  notes: "" },
      { id: uid(), title: "Lesson",   clientId: id.anna,  start: at(2, 18),     durationMin: 30, location: "Pool",    notes: "" },
      { id: uid(), title: "Practice", clientId: id.lily,  start: at(3, 16),     durationMin: 60, location: "Track",   notes: "" },
      { id: uid(), title: "Lesson",   clientId: id.emma,   start: at(4, 16),     durationMin: 60, location: "Court 3", notes: "" },
      { id: uid(), title: "Lesson",   clientId: id.jack,  start: at(7, 17, 30), durationMin: 60, location: "Court 1", notes: "" },
      // A little history so the calendar isn't only forward-looking.
      { id: uid(), title: "Lesson",   clientId: id.emma,   start: at(-2, 16),    durationMin: 60, location: "Court 3", notes: "" },
      { id: uid(), title: "Lesson",   clientId: id.ben,    start: at(-3, 7),     durationMin: 90, location: "Lane 4",  notes: "" },
      { id: uid(), title: "Session",  clientId: id.tom, start: at(-6, 11),    durationMin: 45, location: "Zoom",    notes: "" }
    ].map(function (e) { e.source = "local"; return e; });

    const profile = {
      name: "Alex Carter", title: "Tennis & Performance Coach",
      email: "alex@example.com", phone: "555-0100",
      location: "Austin, TX", website: "alexcarter.example.com",
